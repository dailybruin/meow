...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.shorten_links'
        db.add_column(u'scheduler_section', 'shorten_links',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.shorten_links'
        db.delete_column(u'scheduler_section', 'shorten_links')
    ...
    models = {
        ...
        u'scheduler.section': {
            ...
            'facebook_default_photo': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_selector': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'shorten_links': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'scheduler.smpost': {
            ...
            'featured_image_url': ('django.db.models.fields.URLField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_edit_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'story_short_url': ('django.db.models.fields.URLField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
