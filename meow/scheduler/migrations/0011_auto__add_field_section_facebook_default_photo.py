...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.facebook_default_photo'
        db.add_column(u'scheduler_section', 'facebook_default_photo',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.facebook_default_photo'
        db.delete_column(u'scheduler_section', 'facebook_default_photo')
