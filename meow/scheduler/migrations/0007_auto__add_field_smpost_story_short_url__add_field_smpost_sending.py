...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SMPost.story_short_url'
        db.add_column(u'scheduler_smpost', 'story_short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SMPost.sending'
        db.add_column(u'scheduler_smpost', 'sending',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SMPost.story_short_url'
        db.delete_column(u'scheduler_smpost', 'story_short_url')

        # Deleting field 'SMPost.sending'
        db.delete_column(u'scheduler_smpost', 'sending')
