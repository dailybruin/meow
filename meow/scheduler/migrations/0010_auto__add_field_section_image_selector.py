...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.image_selector'
        db.add_column(u'scheduler_section', 'image_selector',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.image_selector'
        db.delete_column(u'scheduler_section', 'image_selector')
