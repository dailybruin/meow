...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SMPost.last_edit_user'
        db.add_column(u'scheduler_smpost', 'last_edit_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SMPost.last_edit_user'
        db.delete_column(u'scheduler_smpost', 'last_edit_user_id')
