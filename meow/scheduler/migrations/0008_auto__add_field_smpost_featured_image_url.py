...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SMPost.featured_image_url'
        db.add_column(u'scheduler_smpost', 'featured_image_url',
                      self.gf('django.db.models.fields.URLField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SMPost.featured_image_url'
        db.delete_column(u'scheduler_smpost', 'featured_image_url')
