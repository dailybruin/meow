  ...
  (function(n) {
    ...
    return (
      ...
      (r.replace = function(n, r) {
        ...
        return (
          e
            ? (n.xregexp && (u = n.xregexp.captureNames), n.global || (o = n.lastIndex))
            : (n += ""),
          s(r, "function")
            ? (f = i.replace.call(String(this), n, function() {
                ...
                if (u)
                  for (t[0] = new String(t[0]), i = 0; i < u.length; ++i)
                    u[i] && (t[0][u[i]] = t[i + 1]);
                return (
                  e && n.global && (n.lastIndex = t[t.length - 2] + t[0].length), r.apply(null, t)
                );
              }))
            : ((h = String(this)),
      ...
      u(
        ...
        function(n, t) {
          if (
            !(t === e && /^[1-9]/.test(n[1]) && +n[1] <= this.captureNames.length) &&
            n[1] !== "0"
          )
            throw new SyntaxError(
              "can't use octal escape or backreference to undefined group " + n[0]
            );
          return n[0];
        },
        { scope: "all" }
...
(function(n) {
  ...
  n.build = function(f, e, o) {
    ...
    for (c in e)
      e.hasOwnProperty(c) &&
        ((a = t(e[c])), (l[c] = { pattern: u(a.source), names: a.xregexp.captureNames || [] }));
    return (
      (f = t(f)),
